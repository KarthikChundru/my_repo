...
public class LambdaTest1 {
	...
	public static void main(String[] args) {
		...
		//System.out.println("Addition: " + addition.operation(15, 12));
		System.out.println("Subtraction: " + subtraction.operation(4, 3));
		System.out.println("Multiplication: " + multiplication.operation(7, 3));
		System.out.println("Division: " + division.operation(20, 10));
		
		BiFunction<Integer,String, String>orderDetails = (price,status)->{
			if(price > 10000) {
				return "Order details : Price = " + price + "Status = " + status;
			}
			return "Order not valid";
		};
		System.out.println(orderDetails.apply(20000,"ACCEPTED"));
